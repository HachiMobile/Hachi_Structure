...
import generateConfig from "@/theme/ThemeProvider/generateConfig.ts";
import {ComponentTheme, Theme} from "@/types/theme/theme.ts";
import {APP_CONFIG} from "@/shared/utils/app-config.ts";
...
function ThemeProvider({ children, storage }: Props) {
    ...
    useEffect(() => {
        ...
        // enum appHasThemeDefined = storage.contains(
